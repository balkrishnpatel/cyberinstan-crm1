...
const FinanceProfile = () => {
  ...
  const [profileData, setProfileData] = useState({
    ...
    bio: 'Experienced finance professional with 6+ years in financial planning, analysis, and compliance management.',
    specializations: 'Financial Analysis, Budget Planning, Tax Compliance, Audit Management',
    certifications: 'CA, CFA Level II, SAP Finance'
  });
  ...
  return (
    <div className="p-6 space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-orange-200 text-sm">Finance Management System</p>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">Financial Specializations</h2>
          {isEditing ? (
            <textarea
              ...
              rows={4}
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent"
              placeholder="List your financial specializations..."
            />
          ) : (
      ...
      {/* Certifications */}
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <h2 className="text-lg font-semibold text-gray-900 mb-4">Professional Certifications</h2>
        {isEditing ? (
          <input
            type="text"
            name="certifications"
