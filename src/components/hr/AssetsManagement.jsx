...
import { Package, Plus, Search, Filter, User, Calendar, MapPin } from 'lucide-react';
...
const AssetsManagement = () => {
  ...
  const loadData = () => {
    ...
    const assetsData = getFromStorage('assets') || [];
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Track and manage company assets and allocations</p>
        </div>
        <button
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200">
        <div className="px-6 py-4 border-b border-gray-200">
          <h2 className="text-lg font-semibold text-gray-900">Company Assets</h2>
        </div>
