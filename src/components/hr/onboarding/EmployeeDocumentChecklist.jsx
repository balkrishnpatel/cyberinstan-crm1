...
// const EmployeeDocumentChecklist = ({ employeeId, isLoading, setIsLoading,  onNextTab }) => {
//   const [errors, setErrors] = useState({});
//   const [documentChecklist, setDocumentChecklist] = useState({
//     checklist_id: null,
//     passport_size_photo: null,
...
//             existingDocs[field] = checklistData[field];
//           }
//         });
...
//         console.log('Setting document checklist:', `${BASE_URL}${checklistData.resume_url}`);
//         // console.log('Setting document checklist:', checklistData.resume_url);
//       } else {
//         console.log('No document checklist data found for employee');
//         resetDocumentChecklist();
//       }
...
//       resume_url: null,
//       signed_offer_letter_url: null,
//       cheque_for_trainee_url: null,
//       medical_certificate_for_trainee_url: null,
//       pan_card_url: null,
//       aadhaar_card_url: null,
//       passport_url: null,
//       tenth_marks_card_url: null,
//       twelfth_marks_card_url: null,
//       degree_marks_card_certificate_url: null,
//       master_marks_card_certificate_url: null,
//       current_local_address_proof_url: null,
//       permanent_address_proof_url: null,
//       experience_letter_url: null,
//       relieving_letter_url: null,
//       last_3months_payslip_url: null,
//       physical_verification_date: ''
//     });
//     setExistingDocuments({});
//     setFileInputs({});
...
//                   }}
//                 />
//                 {console.log(getDocumentURL(existingFile))}
//                 <div className="hidden p-4 bg-gray-100 rounded text-center text-sm text-gray-500">
//                   Image preview not available
//                 </div>
//               </div>
...
//         {newFile && (
//           <div className="mt-2">
//             <span className="text-sm text-blue-600">New file selected: {newFile.name}</span>
//           </div>
//         )}
...
//     <div className="document-checklist-section p-6 bg-white rounded-2xl shadow-md">
//       {/* Header */}
//       <div className="document-header mb-6 border-b pb-2">
//         <h3 className="text-2xl font-semibold text-gray-800">Document Checklist</h3>
//         <p className="text-sm text-gray-600 mt-1">Upload required employee documents</p>
//       </div>
...
//       {/* Action Buttons */}
//       <div className="document-actions flex flex-col md:flex-row justify-end items-center gap-4 mt-8">
//         <div className="action-buttons flex flex-wrap gap-3">
//           <button
//             type="button"
//             onClick={saveDocumentChecklist}
